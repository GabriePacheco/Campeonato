...
?>
 <div class="ventana">
      ...
      <div class="subtitulos">Detalle de Equipos.</div>
      <div  id="conten" class="conten">
       <?php include_once('tabla_equipos.php');?>
      </div>
      <div class="v_pie">     
          <div id="botones_t">
          <?php
  ...
  $(document).ready(function (){
    ...
    $('tr').click(function (){
     ...
     $('#borrar').click(function (){
        ...
        url:'borrar.php',
        type: 'post',
        data: 'tabla=equipos&id='+$("#selecionado").val(),
        success:function (m){
          mensaje(m);
          reload();
     ...
     $('#editar').click(function (){
        ...
        document.location.href="inicio.php?mm1=eequipo&id="+$("#selecionado").val();    
     })
