...
?>
<a style="width:100%;color:#fff;text-aling:right;background:#999;padding:0.3em;" href="javascript:agestor2()" id="x" ><b>x</b></a>
<div class="ventana">               
 <form id="efecha" action="javascript:agestor()" method="POST" >
